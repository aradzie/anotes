...
function peg$parse(input, options) {
  ...
  const peg$e25 = peg$literalExpectation("c", false);
  const peg$e26 = peg$classExpectation([["1", "9"]], false, false, false);
  const peg$e27 = peg$literalExpectation("::", false);
  const peg$e28 = peg$classExpectation(["-", "_", ["a", "z"], ["0", "9"]], false, true, false);
  const peg$e29 = peg$otherExpectation("newline");
  ...
  function peg$f25(cond, items, end) {
  ...
  function peg$f26(field) {    return { type: "field", field, loc: location() };  }
  function peg$f27(field) {    return { field, not: false, loc: location() };  }
  function peg$f28(field) {    return { field, not: true,  loc: location() };  }
  function peg$f29(field) {    return { field, loc: location() };  }
  function peg$f30(text) {    return { text: text.replaceAll(/\s+/g, " "), loc: location() };  }
  function peg$f31(id, text, hint) {    return { id, text, hint };  }
  ...
  function peg$parseCloze() {
    let s0, s1;

    s0 = [];
    s1 = peg$parseClozeText();
    if (s1 === peg$FAILED) {
      s1 = peg$parseClozeDeletion();
    }
    while (s1 !== peg$FAILED) {
      s0.push(s1);
      s1 = peg$parseClozeText();
  ...
  function peg$parseClozeDeletion() {
    let s0, s1, s2, s3, s4, s5, s6, s7;
  ...
  function peg$parseClozeHiddenText() {
    let s0, s1;

    s0 = [];
    s1 = peg$parseClozeFragment();
    if (s1 === peg$FAILED) {
      s1 = peg$parseClozeDeletion();
    }
    if (s1 !== peg$FAILED) {
  ...
  function peg$parseClozeFragment() {
    let s0, s1, s2, s3, s4;
